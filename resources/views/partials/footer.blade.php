...
<script src="{{ asset('backend/assets/js/table-treeview.js') }}v"></script>
...
<!-- Chart Custom JavaScript -->
<script async src="{{ asset('backend/assets/js/slider.js') }}"></script>

<!-- app JavaScript -->
<script src="{{ asset('backend/assets/js/app.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/moment.min.js') }}"></script>
</body>
